...
//    private Skin skin;
    ...
    private TextButton lastSavedGameButton;
    ...
    // custom button
        ...
        lastSavedGameButton = new TextButton("Saved Game", textButtonStyle); // New Button
        ...
        table.row();
        table.add(lastSavedGameButton).size(200, 50).pad(10); // Add new button to the table
        table.row();
        ...
        lastSavedGameButton.addListener(new ClickListener() { // New Button Listener
            @Override
            public void clicked(InputEvent event, float x, float y) {
                uiManager.showLastSavedGame(); // Implement this in UIManager
            }
        });
